...
- [ ] Промпты (.md): `SDTWork/...` пути к config/routing
...
> **Урок (2026-02-22):** Рефакторинг memory/ (slim CLAUDE.md) сломал 3 места: template-sync ссылался на удалённые файлы, backup содержал stale копии, SDT не получил новые файлы. Причина: не было чеклиста для изменений структуры memory/.
