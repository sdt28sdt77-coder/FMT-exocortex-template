...
## РП текущей недели (W23: 01–07 июн)

> Порядок: in_progress → pending → done.

| # | РП | Бюджет | Статус | Дедлайн | → R |
|---|-----|--------|--------|---------|-----|
| 14 | Подключение к MQ | 2-3h | 🔄 in_progress | — | R1 |
| 10 | Актуализировать IWE | 1-2h | ⏳ pending | — | R1 |
| 12 | Стратегическая сессия | 1-2h | ⏳ pending | — | R1 |
| 19 | Согласование реестра интерфейсов | 1h | ⏳ pending | — | R1 |
| 25 | Получение Отказов через Kafka | — | ⏳ pending | — | R1 |
