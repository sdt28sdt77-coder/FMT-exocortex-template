...
## РП текущей недели (W25: 15–21 июн)

> Порядок: in_progress → pending → done.
> Обновлено: 2026-06-13 (стратегическая сессия)

| # | РП | Бюджет | Статус | Дедлайн | → R |
|---|-----|--------|--------|---------|-----|
| 14 | Подключение к MQ | 2-3h | 🔄 in_progress | — | R1 |
| 33 | CLCTN-303: Описание для Базы Знаний | — | ✅ completed | — | R1 |
| 34 | Мердж в мастер сигналов | — | ⏳ pending | — | R1 |
| 35 | Разработка МРИП | — | ⏳ pending | — | R1 |
| 35.1 | Коммент Щетинина про стрелки | — | ✅ completed | — | 35 |
| 35.2 | Связки компонентов через ЭПО | — | ⏳ pending | — | 35 |

> D3 (17 июн): РП 33 ✅, РП 35.1 ✅
