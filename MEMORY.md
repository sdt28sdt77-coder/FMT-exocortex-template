...
| 19 | Согласование реестра интерфейсов | 1h | 🔄 in_progress | — | R1 |
| 19.4 | Заменить тестовые среды на промежуточные | — | 🔄 in_progress | — | 19 |
| 19.5 | Комментарий о переименовании во фронт и связях | — | ⏳ pending | — | 19 |
