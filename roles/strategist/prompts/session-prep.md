...
Источник сценария: SDTWork/PACK-digital-platform/pack/digital-platform/02-domain-entities/DP.ROLE.012-strategist/scenarios/scheduled/01-strategy-session.md

## Контекст

- **HUB (личные планы):** SDTWork/DS-strategy/current/
- **Документы стратегии:** SDTWork/DS-strategy/docs/ (ВСЕ файлы: Strategy.md, Dissatisfactions.md, Session Agenda.md)
- **Inbox:** SDTWork/DS-strategy/inbox/ ([fleeting-notes.md](https://github.com/your-username/DS-strategy/blob/main/inbox/fleeting-notes.md) + свежие файлы за неделю)
- **SPOKE (планы репо):** SDTWork/*/WORKPLAN.md
- **Стратегические карты:** SDTWork/*/MAPSTRATEGIC.md (если есть в репо)
- **MEMORY:** ~/.claude/projects/SDTWork/memory/MEMORY.md
...
- Прочитай `SDTWork/*/MAPSTRATEGIC.md` (если файл есть в репо)
...
- Прочитай `SDTWork/*/WORKPLAN.md` из каждого репо
