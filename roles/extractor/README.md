...
|-------|------|---------|------|
| Мой домен | PACK-my-domain | MD | SDTWork/PACK-my-domain/pack/my-domain/ |
```

### 2. (Опционально) Установи автоматический inbox-check

```bash
cd SDTWork/SDT/roles/extractor
bash install.sh
```
...
bash SDTWork/SDT/roles/extractor/scripts/extractor.sh inbox-check

# Knowledge Audit
bash SDTWork/SDT/roles/extractor/scripts/extractor.sh audit
```
