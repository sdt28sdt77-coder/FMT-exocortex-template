...
1. Прочитай `SDTWork/SDT/roles/extractor/config/routing.md` — таблицы маршрутизации.
2. Прочитай `SDTWork/SDT/roles/extractor/config/feedback-log.md` — лог отклонённых кандидатов. Если capture похож на ранее отклонённый → пропусти.

### Шаг 1: Проверить inbox

1. Прочитай `SDTWork/DS-strategy/inbox/captures.md`
...
Создай файл отчёта: `SDTWork/DS-strategy/inbox/extraction-reports/{YYYY-MM-DD}-inbox-check.md`
