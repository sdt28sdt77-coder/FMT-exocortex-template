...
```bash
cd /Users/alfa/iwe/sdt/SDT1 && bash update.sh --check 2>&1
```
...
Прочитать `SDT1/CHANGELOG.md`. Найти записи между текущей и новой версией.
...
```bash
cd /Users/alfa/iwe/sdt/SDT1 && bash update.sh --yes 2>&1
```
